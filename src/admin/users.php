...
<head>
    ...
    <title>Score Board - User Management</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="text-center mb-5">
            ...
            <p class="app-subtitle">Add, edit, and manage participants</p>
        </div>
        
        <div class="row mb-4">
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="h3"><i class="bi bi-people-fill me-2"></i>Manage Users</h2>
                    <div>
                        <a href="/admin/" class="btn btn-outline-primary me-2">
                            <i class="bi bi-person-badge me-1"></i> Manage Judges
                        </a>
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr>
                                ...
                                <th width="15%"><i class="bi bi-trophy-fill me-1"></i>Total Points</th>
                                <th width="15%"><i class="bi bi-people-fill me-1"></i>Judges</th>
                        ...
                        <tbody class="stagger-children">
                            ...
                            <tr>
                                <td class="text-center fw-bold"><?php echo htmlspecialchars($user['id']); ?></td>
                                <td class="fw-medium"><?php echo htmlspecialchars($user['name']); ?></td>
                                <td>
                                    <span class="points-badge"><?php echo htmlspecialchars($user['total_points']); ?></span>
                                </td>
